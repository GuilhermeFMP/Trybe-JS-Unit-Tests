...
Quinto projeto de Fundamentos fornecido pela instituição Trybe, onde criamos testes em Jest.


## Aprendizados

Aprendi a como realizar testes em Jest, utilizar Matchers e aplicar Cobertura de Testes.
...
```bash
  git clone git@github.com:GuilhermeFMP/Trybe-JS-Unit-Tests.git
